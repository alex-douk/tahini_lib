...
impl<'a> ServiceGenerator<'a> {
    ...
    fn struct_client(&self) -> TokenStream2 {
        ...
        quote! {
            ...
            #vis struct #client_ident(::tahini_tarpc::client::TahiniChannel<#request_ident, #response_ident>);
        }
    }
        ...
        quote! {
            impl #client_ident {
                ...
                -> ::tahini_tarpc::client::TahiniNewClient<
                    ...
                    >
                where
                    T: ::tahini_tarpc::transport::TahiniTransportTrait<::tarpc::ClientMessage<::alohomora::tarpc::enums::TahiniSafeWrapper<#request_ident>>,
